...
function NotFoundComponent() {
  ...
  const isAdmin = matches.some((m) => m.routeId.startsWith("/modular/admin"));
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4">
        <div className="max-w-md text-center">
          ...
          <h2 className="mt-4 text-xl font-semibold text-gray-700">Admin page not found</h2>
          ...
          <div className="mt-6">
            <Link
              to="/modular/admin"
              className="inline-flex items-center justify-center rounded-md bg-[var(--gold-muted)] px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-[var(--gold)]"
            >
              Go to Dashboard
            </Link>
          </div>
...
function useIsAdminRoute(): boolean {
  const matches = useMatches();
  return matches.some((m) => m.routeId.startsWith("/modular/admin"));
}
